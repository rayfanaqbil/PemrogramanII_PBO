...
namespace P10_714220044.view
{
    public partial class FormNilai : Form
    {
        ...
        private void btnSimpan_Click_2(object sender, EventArgs e)
        {
            if (cbmatkul.SelectedIndex == -1 || cbkategori.SelectedIndex == -1 ||
              cbnpm.SelectedIndex == -1 || tbnilai.Text == "")
            {
        ...
        private void btnUbah_Click_2(object sender, EventArgs e)
        {
            if (cbmatkul.SelectedIndex == -1 || cbkategori.SelectedIndex == -1 ||
                cbnpm.SelectedIndex == -1 || tbnilai.Text == "")
            {
        ...
        private void btnHapus_Click_2(object sender, EventArgs e)
        {
